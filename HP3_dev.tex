...
\begin{tlg}[hp03_021]
\tl{
\pada{\app{\lem[wit={N3,J5,Gr3a},post=\texteng{(tu for ca \getsiglum{K3})}]{recayec ca śanair eva}
...
\pada{\app{\lem[wit={C6,V15,V1},alt={dakṣiṇāṅge sam°}]{dakṣiṇāṅge sama}
		...
		\NotIn{Gr3a}\myfn{\getsiglum{N3,J5} have this verse here. \getsiglum{Gr3a} omits it. The other mss have it after \ref{mahabandha}.}\\!}
...
\pada{\app{\lem[wit={ceteri},alt={tasya syād}]{tasya syā\skp{d}}
	...
	\app{\lem[wit={J5,C6,P11,K3,C7,V1,N19,V15,J10,Jyo},alt={siddhāṅganā}]{\skm{t }siddhāṅganā}
