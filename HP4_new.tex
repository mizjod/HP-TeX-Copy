...
\pada{samādhikrama% 
	\app{\lem[wit={C6,V3,Gr4c,J10,Jyo}]{m uttamam}
...
\pada{\crux\app{\lem[wit={ceteri}]{jñānān}
		\rdg[wit={V15,J10}]{jñāna}
		\rdg[wit={Jyo}]{jñānaṃ}
		\rdg[wit={V19}]{jñān}}
	\app{\lem[resp=emend]{muktiḥ sthitā}% muktisthitā P6
...
\pada{patitaṃ \app{\lem[wit={C6,V3,Gr4c,Jyo}]{vadane}
	\rdg[wit={J10}]{pavane}
	\rdg[wit={Gr2,Gr3a},alt={\om}]{}} yasya}
\pada{jagad etac carācaram//} % yagad V19; carāccaraṃ J7
	\lineom{bc}{Gr2,Gr3a}\\!

% 4.009_2
\pada{citte
	\app{\lem[wit={C6,V3,J7,Gr3a,J10,Jyo}]{samatvam} 
		\rdg[wit={Gr4c}]{śamatvam}
		\rdg[wit={N23}]{samatyam}} āpanne}
...
\pada{mārutasya layo
	\app{\lem[wit={ceteri},alt={nāthas/nāthaḥ/nātho}]{nāthas}
		\rdg[wit={J7}]{nāthāḥ}}}
\pada{\app{\lem[wit={N3,V3,Gr4c,J10}]{taṃ nāthaṃ layam āśrayet}
...
\pada{\app{\lem[wit={N3,C6,V3,Gr2,J10}]{dṛṣṭir}
		...
		\rdg[wit={Gr4c}]{dṛṣṭe}
		\rdg[wit={Jyo}]{dve a°}}
	\app{\lem[wit={N3,P11,V3,N19},alt={lakṣ(y)e layaṃ gatā}]{lakṣye layaṃ gatā} % gatāḥ N3
...
%\newpage
% 4.019
\pada{antar\app{\lem[wit={V3,Gr2,J10,Jyo},alt={lakṣ(y)aṃ}]{lakṣyaṃ} % antalakṣaṃ P7; °lakṣyaṃ Jyo,C6ac
...
\pada{\app{\lem[wit={P11}]{avasthāyām abhedatā}
		...
		\rdg[wit={Gr2},post={(bhedanaḥ \getsiglum{N23})}]{avasthā ca na bhedataḥ}% °naḥ N23
...
\pada{nādam \app{\lem[wit={N3,P11,Gr2,Jyo},alt={anta(ḥ)stham ekadhīḥ}]{antaḥstham ekadhīḥ}
...
\pada{yoga\app{\lem[wit={ceteri}]{sāmrājyam}
	...
	\app{\lem[wit={C6,V3,J7,Gr3a,V15,Jyo}]{icchatā} % iṣṭatā J5
...
\pada{\app{\lem[wit={N3,C6,V3,Gr2,K3,C7,Gr4c,Jyo},alt={pakṣād/pakṣāt}]{pakṣād}
%		\rdg[wit={K3}]{pakṣāt}
...
\pada{makarandaṃ % ṃ om. V15,J10
	...
	\app{\lem[wit={N3,C6,V3,C7,V15,J10,Jyo}]{bhṛṅgo}
		...
		\rdg[wit={N19}]{śṛṃgo}}}
\pada{\app{\lem[wit={N3,V3,V19}]{gandhān}
...
\pada{\app{\lem[wit={N3,C6,V3,Gr2,C7,Jyo}]{antaraṅga}
		...
		\rdg[wit={K3}]{sarveṣām}}%
	\app{\lem[wit={N3,C6,V3,V19,Gr4c,J10,Jyo}]{bhujaṃgamaḥ} % ṃ om. V3
...
\pada{\app{\lem[wit={N3,P11,V3,Jyo},alt={(°ādī° \getsiglum{N3})}]{ghaṇṭādināda}
%	\rdg[wit={N3}]{ghaṃṭādīnāda}
	\rdg[wit={C6,Gr2,Gr3a}]{ghaṇṭānināda}}% ghaṃṭāki? V19
\app{\lem[resp=emend,postwit={(śakti \getsiglum{J5})}]{sakti}
...
% 4.068
[Alt2]
\pada{\app{\lem[wit={N3,P11,V3,Gr2,Gr3a,Jyo},post={(sabdasya \getsiglum{V3,N23})}]{anāhatasya śabdasya}
...
\pada{\app{\lem[wit={J5,C6,Gr2,Gr3a}]{tasya śabdasya yo dhvaniḥ}
		...
		//}\\+
\pada{\app{\lem[wit={N3,Gr4b,Gr3a,Jyo},postwit={\getsiglum{N23}\textsubscript{pc}}]{dhvaner}
		\rdg[wit={J5,G4,V3,Gr2}]{dhvanir}}
		antargataṃ % °gata N23
	\app{\lem[wit={N3,Jyo}]{jñeyaṃ}
		\rdg[wit={P11,V3}]{geyaṃ}
		\rdg[wit={G4,N23,K3}]{jyotir}
		\rdg[wit={C6,J7,V19,C7}]{jyoti} % om. C6, jyotī P7
		\rdg[wit={J5},alt={\om}]{}}} % =P11
\pada{\app{\lem[wit={Jyo}]{jñeyasyāntar}
...
\pada{\app{\lem[wit={N3,C6,J7,Jyo}]{pavano līyate yatra}
		...
		\rdg[wit={Gr4c},alt={\om}]{}}}
\pada{manas \app{\lem[wit={N3,GrB,V19,C7}]{tatraiva līyate}% +N2
