...
% N3,(P11,)C6,V3, N23,J7, V19,K3,C7(except Vajrolī), P15(up to 13a),N19,V15,J11(3.49-66 only) V1,J10,Jyo
...
\pada{brahma\app{\lem[wit={ceteri}]{dvāra}
	...
	\app{\lem[wit={ceteri}]{suptāṃ}
		\rdg[wit={V3}]{supto}}}
\pada{mudrā\app{\lem[wit={N3,P11,V3,Gr4c,V1,J10,Jyo}]{bhyāsaṃ samācaret}% bhyāsa V3; samabhyaset J14
...
\pada{m ādau varjana%
	\app{\lem[wit={N3,J5,C6,N19,V15,V1},alt={ādiśet}]{m ādiśet}
		\rdg[wit={V3}]{ādṛśyet}
...
\pada{\app{\lem[wit={V3,N23,V19,C7,J6,V15,V1,Jyo}]{chedana}% +J17
		\rdg[wit={J10,N9,N26}]{chedanaṃ}% +J8
		\rdg[wit={C6}]{chedanaiś}
		\rdg[wit={K3}]{khedana}
		\rdg[wit={N19}]{vedana}
		\rdg[wit={J7}]{rasanā}
		\rdg[wit={N3},alt={\damaged}]{}}%
...
\pada{\app{\lem[wit={V15,Gr6}]{kṛtvā}
		\rdg[wit={Jyo}]{tataḥ}}
	\app{\lem[wit={V3,N9,N26,J6}]{saindhavapathyādi}
...
\pada{romamātraṃ \app{\lem[wit={V3,N9,N26}]{samucchidet}
...
\pada{\app{\lem[wit={V3,J6,V15,N26}]{nitya}
		...
		\rdg[wit={N9}]{netya}}%
	\app{\lem[wit={V3,V15,N9,N26}]{yuktaṃ}
		\rdg[wit={Jyo}]{yuktaḥ}
		\rdg[wit={J6}]{muktaṃ}} samācaret/}\\+
\pada{\app{\lem[wit={Gr6,Jyo}]{ṣaṇmāsād}
		\rdg[wit={V15}]{ṣaṇmāse}}
	rasanā\app{\lem[wit={V3,N9,N26,J6,Jyo}]{mūla}
		\rdg[wit={V15}]{mūlaṃ}}}%
...
\pada{kālavelā% kālā N9
	\app{\lem[wit={V3,J6}]{vidhānavit}
		\rdg[wit={N9,N26}]{vidhānataḥ}}//} \sgwit{Gr6}\\!
...
\pada{\app{\lem[wit={V3,N9,J6}]{veṣṭitāmbara}
	\rdg[wit={N26}]{veṣṭitādhāra}}lakṣaṇam//} \sgwit{Gr6}\\!
...
\pada{adhastā\app{\lem[wit={N9,N26,J6},alt={cibukaṃ mūlaṃ}]{c cibukaṃ mūlaṃ} % cf. J3
...
\pada{krośād ūrdhvaṃ % krośāharddhaṃ J8
	...
	\app{\lem[wit={V3,N9}]{kramati}
		\rdg[wit={J6}]{krāmati}
		\rdg[wit={N26}]{kramatī}}}
\pada{tiryak\app{\lem[wit={V3,J6}]{saṃkhyā}
		\rdg[wit={N9,N26}]{saṃsthā}}vadhi priye//} \sgwit{Gr6}\\!

%[hp03_033_08] % = HP6 and HP10
\pada{punaḥ saṃvatsarād devi}
\pada{dvitīyā caiva līlayā/}\\+ % dvitiyā V3,J15; lilayā N9,J15
\pada{brahma\app{\lem[wit={V3,N26,J6},alt={randhrāntam}]{randhrānta}
		\rdg[wit={N9}]{raṃdhraṃ tam}}m āvṛtya}
\pada{\app{\lem[wit={V3,N26,J6}]{tiṣṭhet}
		\rdg[wit={N9}]{viṣṭaitet}}
	\app{\lem[wit={V3,N26,J6}]{paramavandite}
...
\pada{pūrva\app{\lem[wit={N9,N26}]{bīja}
		\rdg[wit={V3}]{vīya}
...
\pada{sā śivatva\app{\lem[wit={V3,N9,N26}]{samavāya} % śivatta N9
		\rdg[wit={J6}]{samavāyi}}%
	\app{\lem[wit={N9,N26,J6}]{kāriṇī}
		\rdg[wit={V3}]{kariṇī}}}\\+
\pada{khecarī 
...
\pada{krameṇaiva
	\app{\lem[wit={V3,N9,N26}]{prakartavyā}
		\rdg[wit={J6}]{pravartavyā}}}%
\pada{bhyāsena
	vara\app{\lem[wit={V3,N9,N26}]{varṇini}
		\rdg[wit={J6}]{varṇinī}}/}\\+
\pada{yugapad
	\app{\lem[wit={V3,N9,J6},post={(yatete \getsiglum{J6}\textsuperscript{ac})}]{yatate} % yatete J6ac
...
\pada{\app{\lem[wit={V3,J6}]{'bhyāso na}
		\rdg[wit={N9,N26}]{bhyāsena}} yugapat 
	\app{\lem[wit={V3,N9,J6}]{priye}
	\rdg[wit={N26}]{kriye}}/}\\+
\pada{\app{\lem[wit={N9,N26,J6}]{evaṃ}
		\rdg[wit={V3}]{eva}} varṣatrayaṃ kṛtvā} % kṛtvā illeg. N26
\pada{brahmadvāraṃ
	\app{\lem[wit={N26,J6},alt={viśed}]{viśe}
		\rdg[wit={N9}]{vaśed}
...
śakti\app{\lem[wit={N26,J6}]{bhujagīṃ}
	...
	\app{\lem[wit={V3,N9,N26}]{protthāpya}
...
\app{\lem[wit={N26,J6}]{pibatī}
		\rdg[wit={V3,N9}]{pibate}}ndumaṇḍalagalan% galat V3,J15
	\app{\lem[wit={V3,N26}]{muktaḥ sa sākṣācchivaḥ}
...
\pada{nityaṃ
	\app{\lem[wit={V3,N9,N26}]{yas tūrdhva}
...
saptadhārāmṛ\app{\lem[wit={V3,N26}]{taughaṃ}
	\rdg[wit={N9}]{tauṣaṃ}
	\rdg[wit={J6}]{tauccaṃ}}}\\+
\pada{\app{\lem[wit={V3,N9,N26}]{susvādaṃ}
...
\pada{piṇḍasthairyaṃ hi tasmād bhavati
	\app{\lem[wit={N9,N26}]{mṛtapathā} % mṛtta N9
	\rdg[wit={V3}]{mṛtayathā}
	\rdg[wit={J6}]{mṛtaṃ yathā}}
	mṛtyu\app{\lem[wit={V3,J6}]{rogād}
		\rdg[wit={N26}]{rogod}
		\rdg[wit={N9}]{śeṣād}}
	\app{\lem[wit={V3,N9}]{bhavanti}
		\rdg[wit={J6}]{bhavati}
...
\pada{amaratvaṃ \app{\lem[wit={V3,N26}]{labhed}
		\rdg[wit={N9,J6}]{labhate}} dhruvam//} \sgwit{Gr6}\\! % labhe V3

%\newpage
%[hp03_033_18]% = HP6
\pada{madhusvādūpamaṃ caiva}
\pada{śāstram
	\app{\lem[wit={V3,N9,N26}]{udgirate}
	\rdg[wit={J6}]{udgirati}}
	\app{\lem[wit={N9,N26,J6}]{bahu}
	\rdg[wit={V3}]{bahuḥ}}/}\\+
...
\pada{\app{\lem[wit={ceteri}]{māsārdhena na}
	...
	\rdg[wit={N3},alt={\damaged}]{}} saṃdeho}
...
%		\rdg[wit={J8}]{kaṭukāmna} % sakṣīrodakatikta P11
	...
	\app{\lem[wit={ceteri}]{tulyā} % also V3pc, talyā C6
		\rdg[wit={V3}]{tulyāṃ}
		\rdg[wit={J10}]{tulyaṃ}}%
	\app{\lem[wit={J5,Gr2,Gr3a}]{tha vā}% +N24
...
\pada{\app{\lem[wit={ceteri}]{taṃ}
	...
	\app{\lem[wit={ceteri}]{badhnīyāt}% yāta V3
		...
		\rdg[wit={V15},alt={\om}]{\skp{\om}}}
	\app{\lem[wit={C6,J11}]{sukaraṇamṛdā}
...
%[hp03_051]
\pada{\app{\lem[wit={GrB,J11,V1,Jyo}]{adhogatim} % better, =HR
	\rdg[wit={N3,Gr2,Gr3a,N19,J10}]{adhogatam}} % lost J5,G4
\app{\lem[wit={N3,C6,Gr2,N19,J11,J10}]{apānaṃ vai}
...
\app{\lem[wit={ceteri}]{taṃ}% +C7,P11
	...
	\rdg[wit={K3}]{te}
	\rdg[wit={C6}]{tu}}
\app{\lem[wit={ceteri}]{prāhur}% prāhu V3,V1,J10; +J11 s.l.
	\rdg[wit={N19,J11}]{grāhyaṃ}}} 
\pada{\app{\lem[wit={ceteri}]{mūlabandhaṃ}% mūlabaṃ J11
...
\app{\lem[wit={N3,V3,Gr3a,J10,Jyo}]{pārṣṇyā tu} % prob. V19, pāṣṇyā V3
	...
	\rdg[wit={C6}]{āpīḍya}}}
\pada{\app{\lem[wit={N3,C6,V3,Gr2,V1,J10,Jyo},alt={vāyum ā°}]{vāyum ā} % +J11 s.l.; read pāyum?
...
\app{\lem[wit={N3,J7,V19,J11,J10,Jyo}]{tūḍḍīyate}
	\rdg[wit={V3}]{tūḍiyate}
...
\pada{\app{\lem[wit={N3,C6,V3,Gr2,N19,J11,V1,Jyo}]{tatra}
	\rdg[wit={J10}]{kṣetra}
...
\app{\lem[wit={N3,C6,Gr2,N19,J11,V1,J10,Jyo}]{asau}
	\rdg[wit={C7}]{asam}
	\rdg[wit={V19,K3}]{ayaṃ}
...
\pada{\app{\lem[wit={ceteri},post={(dhārayad \getsiglum{J10})}]{karābhyāṃ dhārayed dṛḍham} % °ye<d>dṛ° J7,V19,V3,J11
...
\app{\lem[wit={N3,C6,V3,J7,Gr3a,J11}]{udare}
	\rdg[wit={N23}]{udara}
	\rdg[wit={N19}]{udaraṃ}
	\rdg[wit={V1,J10}]{upari}}}
\pada{\app{\lem[wit={ceteri}]{kārayed}
	\rdg[wit={J10}]{pīḍayed}}
\app{\lem[wit={N3,C6,V3,J7,J11,V1,J10}]{dhṛdaye {\crux}gale\crux} % kāraye hṛdaye V3, kārayed-hṛ°? V1
...
\pada{\app{\lem[wit={N3,C6,V3,J7,N19,V15,V1,J10,Jyo}]{tasmāt}
	\rdg[wit={N23}]{kasmāt}} saṃcālayen nityaṃ} % saṃcārayen N3ac
...
% N9,N26,J6 (for the Khecaryabhyāsakrama only)
...
\getsiglum{J11} & J14 & Gr4c & collated for 3.49--66 only as substitute for \getsiglum{V15}\\
\getsiglum{V1} & V1 & Gr4c/4d & \\
\getsiglum{J10} & J10 & Gr4d\\
\getsiglum{N9} & N9 & Gr6c & collated only for 3.32*1--33*19\\
\getsiglum{N26} & N26 & Gr6c & as above\\
