...
atha samādhiḥ/ \sgwit{N3,Gr4b}
\end{altava}


\startgray
\begin{tlg}[hp04_000*1]
\tl{
...
\pada{samādhikrama%
	\app{\lem[wit={C6,V3,Gr4c,J10,Jyo},alt={°m uttamam}]{\skp{°}m uttamam}
...
\startaltrecension
\begin{alttlg}[hp04_000*3]
\tl{
\pada{\app{\lem[wit={V15,Jyo}]{rājayogaḥ}
		\rdg[wit={C6,N19,J10}]{rājayoga}}
	\app{\lem[wit={Gr4c},alt={samādhiḥ syād}]{samādhiḥ syā\skp{d}} % samādhi V15
		\rdg[wit={C6,J10,Jyo}]{samādhiś ca}}d}
...
\pada{\app{\lem[wit={V15,J10}]{amaraugho}
	...
	\app{\lem[wit={C6,N19,J10,Jyo},alt={layas}]{laya\skp{s}}
		\rdg[wit={V15}]{layes}}%
	\app{\lem[wit={C6,Gr4c,Jyo},alt={tattvaṃ}]{\skm{s }tattvaṃ}
		\rdg[wit={J10}]{tatra}}}
...
\myfn{\getsiglum{C6} has these verses on synonyms both here and at \ref{A1}/\ref{A2}, but \getsiglum{P11} only at the latter place.}\\!}
\end{alttlg}
\endaltrecension

\startgray
\begin{tlg}[hp04_000*5]
\tl{
...
\pada{\crux\app{\lem[wit={ceteri},alt={jñānān}]{jñānā\skp{n}}
	...
	\app{\lem[wit={C6,Gr4c,Jyo},alt={siddhir}]{siddhi\crux\skp{r}}
...
\pada{\app{\lem[wit={P11,V15}]{śūnyaṃ}
		...
		\rdg[wit={C6,Gr2,Gr3a,Jyo}]{śūnye}
		\rdg[wit={V3}]{śūne}
		\rdg[wit={N19}]{śūnyā}} viśati
	\app{\lem[wit={P11,V3,Jyo}]{mānase} % Marmasthāna
		\rdg[wit={J10}]{mārutaḥ}
		\rdg[wit={C6,Gr2,Gr3a,Gr4c}]{mārute}}\marma/}\\+}
\tl{
...
\pada{mārutasya layo
	\app{\lem[wit={ceteri},alt={nāthas/nāthaḥ/nātho}]{nātha\skp{s/nāthaḥ/nātho}}
		\rdg[wit={J7}]{nāthāḥ}}}%
\pada{\app{\lem[wit={N3,V3,Gr4c,J10},alt={taṃ nāthaṃ layam āśrayet}]{\skm{s }taṃ nāthaṃ layam āśrayet}
		\rdg[wit={C6,Gr2,K3,C7,Jyo}]{sa layo nādam āśritaḥ}
...
\pada{\app{\lem[wit={N3,C6,V3,Jyo}]{niśceṣṭo}
		...
		\rdg[wit={J10}]{niścalo}}
	\app{\lem[wit={C6,V3,N23,Gr4c,J10,Jyo}]{nirvikāraś ca} % nirvikā<<ra>>ś N23, nivikāraś V15
		\rdg[wit={N3}]{nirvikāras tu} % nivikalpas tu J5
		\rdg[wit={J7,Gr3a}]{nirvikārāś ca}}}
\pada{\app{\lem[wit={N3,C6,V3,Gr4c,J10,Jyo}]{layo}
		\rdg[wit={V19}]{laye}
		\rdg[wit={Gr2,K3,C7}]{layaṃ}}
	\app{\lem[wit={N3,C6,V3,Gr4c,J10,Jyo}]{jayati}
		\rdg[wit={Gr2,Gr3a}]{yānti ca}}
	\app{\lem[wit={N3,C6,V3,Gr4c,Jyo}]{yoginām}
...
\pada{\app{\lem[wit={N3,Gr2,Gr3a}]{syāc chaktiḥ}
		\rdg[wit={C6,V3,Gr4c,J10,Jyo},post=\texteng{(sa \getsiglum{V15})}]{sā śaktir}} % sa V15
	\app{\lem[wit={N3,C6,V3,J10,Jyo}]{jīva}
...
\pada{\app{\lem[wit={N3,C6,Gr2,Jyo}]{guptā kulavadhūr iva}% vadhū iva P7
		...
		\rdg[wit={Gr4c},post=\texteng{(cf.\,\ref{gopita}d)}]{sarvatantreṣu gopitā}% ##
...
\pada{\app{\lem[wit={ceteri}]{mudreyaṃ}
	...
	\app{\lem[wit={N3,P11,V3,J10}]{khecarī} % = source
		...
		bhavati sā
	\app{\lem[wit={N3,V3,Gr3a,Gr4c},alt={yuṣmat}]{yuṣma\skp{t}}% +J10pc
		\rdg[wit={J7}]{<<yu>>ṣmat}
		\rdg[wit={J10}]{yuṣmān}
		\rdg[wit={N23}]{puṣpat}
		\rdg[wit={C6}]{yasya}
...
\pada{\app{\lem[wit={ceteri},alt={candrārkāv}]{candrārkā\skp{v}}
	...
	\app{\lem[wit={Gr2,Gr3a,Gr4c},alt={upanayen}]{\skm{m }upanaye\skp{n}} % upanaye V19,N19
...
\pada{\app{\lem[wit={ceteri}]{tattvaṃ} % tatva V3
	...
	\app{\lem[wit={ceteri},alt={tat}]{ta\skp{t}}
		\rdg[wit={J10}]{yac}}%
	\app{\lem[wit={Gr2,Gr3a,Jyo},alt={padam eti}]{\skm{t }padam eti}
	...
	\app{\lem[wit={ceteri},alt={atrādhikam}]{\skm{m }atrādhikam}
		...
		\rdg[wit={V19}]{atrāsanaṃ}}//}\label{ardhogha} \NotIn{N3}\\+}
\tl{\anm{\getsiglum{C6,V3,Gr4c,J10,Jyo} have this after \ref{kecid}}\\!}
\end{tlg}
\endgray
...
\pada{\app{\lem[wit={P11}]{avasthāyām abhedatā}
...
\pada{śūnye citsukharūpiṇi//} \sgwit{Jyo}}\\!} % +M1,G8
\end{tlg}
...
\pada{kiṃci%d
	...
	\lineom{ab}{N3}\\+}
\tl{
\pada{\app{\lem[wit={V3,K3,C7,Gr4c},alt={pūrvayogasya mārgo'yam}]{pūrvayogasya mārgo'ya\skp{m}}
...
\pada{\app{\lem[wit={V3,Gr3a,Gr4c,Jyo},alt={unmanī}]{\skm{m }unmanī} % yaṃmunmanī N19
...
\pada{candrā%t % caṃdrā N3
	\app{\lem[wit={Gr2},alt={sāraḥ}]{\skm{t }sāraḥ}
		\rdg[wit={Gr3a}]{srāvaḥ}
		\rdg[wit={N3}]{sāro}}
	\app{\lem[wit={Gr2,K3,C7}]{sravati}% savati J7
		\rdg[wit={V19}]{śravati}
		\rdg[wit={N3}]{grasati}}
	\app{\lem[wit={N3,N23,Gr3a},alt={vapuṣas}]{vapuṣa\skp{s}}
		\rdg[wit={J7}]{puruṣas}}s
	tena mṛtyur narāṇām}\\+} % mūtyur N23
\tl{
\pada{\app{\lem[wit={N3,J7,Gr3a},alt={taṃ badhnīyāt}]{taṃ badhnīyā\skp{t}}
		\rdg[wit={N23}]{tadvahyaṃpāt}}%
	\app{\lem[wit={N3},alt={sukaraṇamṛdā}]{\skm{t }sukaraṇamṛdā}
...
\begin{altava}[hp04_025_2]
atha \app{\lem[wit={C6,Jyo}]{khecarī}
	\rdg[wit={P11}]{khecarīsamādhiḥ}}/ \sgwit{Gr4b,Jyo}
\end{altava}

\begin{alttlg}[hp04_025_2]
\tl{
\pada{\app{\lem[wit={V3,J10},post=\texteng{\textless\ sukhiraṃ}]{suṣiraṃ} % cf. 3.50 suciraṃ
		\rdg[wit={N19}]{suṣiro}
...
\begin{alttlg}[hp04_025_3]
\tl{
\pada{\app{\lem[wit={C6,Gr4c,J10,Jyo},post=\texteng{(nāḍi \getsiglum{N19,J10})}]{savyadakṣiṇanāḍīstho}
...
\tl{
\pada{\app{\lem[wit={P11,V3,Gr4c},alt={pūrayen}]{pūraye\skp{n}}
		\rdg[wit={Jyo}]{pūrayed}
		\rdg[wit={J10}]{pūjayed}}%
	\app{\lem[wit={P11,V3,Gr4c},alt={mārutaṃ divyaṃ}]{\skm{n }mārutaṃ divyaṃ}
...
\pada{\app{\lem[wit={GrB,V15,J10,Jyo}]{ghaṭa}
	...
	\app{\lem[wit={Gr4c},alt={tiṣṭhate}]{\skm{t }tiṣṭhate}
		\rdg[wit={GrB,J10,Jyo}]{tiṣṭhati}} dhruvam//}\\!}
\end{alttlg}

\newpage
\begin{alttlg}[hp04_025_13]
\tl{
\pada{bāhyavāyu%r
	\app{\lem[wit={Gr4c},alt={yadā}]{\skm{r }yadā}
...
\pada{\crux\app{\lem[wit={C6,V3,Gr4c}]{sūryāṅge manasā tathā}% sūryāgnir M1
		\rdg[wit={P11,J10}]{sūryāṅge pavane tathā}
		\rdg[wit={Jyo}]{pavano manasā saha}}\crux//}\\!}
\end{alttlg}

%\newpage
\begin{alttlg}[hp04_025_14]
\tl{
\pada{eva\app{\lem[wit={GrB,Gr4c,J10},alt={abhyasyamānasya}]{\skm{m }abhyasyamānasya}
...
\pada{\app{\lem[wit={GrB,N19,J10,Jyo}]{abhyāsāj jīryate} % abhyāsā V3
		...
		vāyur} % vāyu V3
\pada{mana\app{\lem[wit={Gr4c,J10},alt={tatra vilīyate}]{\skm{s }tatra vilīyate}
		\rdg[wit={GrB,Jyo}]{tatraiva līyate}}//}\\!}
\end{alttlg}


\begin{alttlg}[hp04_025_15]
\tl{
...
\tl{
\pada{manasā
	\app{\lem[wit={Gr4b,Gr4c,J10,Jyo},post=\texteng{(ārokya \getsiglum{N19})}]{mana ālokya}
		\rdg[wit={V3}]{manam ālokya}}}
\pada{\app{\lem[wit={C6,Gr4c},alt={tad dhyāyet}]{tad dhyāye\skp{t}}
		\rdg[wit={P11}]{taṃ dhātaṃ}
		\rdg[wit={V3}]{vaddhyāyait}
		\rdg[wit={J10,Jyo}]{dhārayet}}t paramaṃ padam//}\\!}
\end{alttlg}

\begin{alttlg}[hp04_025_17]
\tl{
...
\newpage
\begin{alttlg}[hp04_025_19]
\tl{
\pada{bāhyacintā na kartavyā} % °tavyo J10
\pada{tathaivāntara%
	\app{\lem[wit={J10,Jyo}]{cintanam}
...
%\newpage
\begin{alttlg}[hp04_025_20]
\tl{
\pada{saṃkalpamātra%
	\app{\lem[wit={Gr4c,J10,Jyo}]{kalanaiva}
		\rdg[wit={V3}]{kalanaṃ ca}} jaga%t
	\app{\lem[wit={V3,Gr4c,Jyo},alt={samagraṃ}]{\skm{t }samagraṃ}
...
\pada{\app{\lem[wit={P11,V3,N19,Jyo}]{āśritya} % āśrītya V3
	...
	\app{\lem[wit={J10,Jyo},alt={niścayam}]{niścaya\skp{m}} % = South Ind. 4c
		\rdg[wit={P11}]{niścalam}
		\rdg[wit={V3}]{niścalayam}
		\rdg[wit={Gr4c}]{niścitam}}%
	\app{\lem[wit={V3,Gr4c,Jyo},alt={avāpnuhi}]{\skm{m }avāpnuhi}
...
%\newpage
\begin{alttlg}[hp04_025_21]
\tl{
\pada{karpūra%m
	\app{\lem[wit={P11,V3,Gr4c,Jyo},alt={anale}]{\skm{m }anale}
...
\pada{\app{\lem[wit={GrB,Gr4c,Jyo},alt={layo viṣaya}]{\skm{l }layo viṣaya}
...
%\newpage
\begin{altava}[hp04_025_27]
atha viśrāntiḥ/ \sgwit{Gr4c} \texteng{or:}
iti viśrāntiḥ/ \sgwit{Gr4b} \anm{?}
\end{altava}

\begin{alttlg}[hp04_025_27]
\tl{
...
\begin{alttlg}[hp04_025_28]
\tl{
\pada{\app{\lem[wit={P11,Gr4c,Jyo}]{aśakya}
		\rdg[wit={J10}]{aśakyaṃ}
		\rdg[wit={C6,V3}]{aśakta}}tattvabodhānāṃ}
\pada{\app{\lem[wit={C6,V3,Gr4c,J10,Jyo},alt={mūḍhānām}]{mūḍhānā\skp{m}}
...
\pada{nādopāsana%m
	\app{\lem[wit={V3,Gr4c,J10,Jyo},alt={ucyate}]{\skm{m }ucyate}
...
\begin{tlg}[hp04_028]% = V3_4.65 = C8_68
\tl{
...
\pada{\app{\lem[wit={N3,C6,V3,J7,Gr3a,V15}]{nāde}
	...
	\app{\lem[wit={N3,C6,J7,Gr4c},alt={manaḥ}]{\skm{n }manaḥ}
		\rdg[wit={V3}]{mana}
...
\pada{\app{\lem[wit={N3,P11,V3}]{bhojye}
	...
	\app{\lem[wit={ceteri}]{bhikṣā} % bhīkṣā V15, bhikṣyā N3
		\rdg[wit={J10}]{bhuktaṃ}}%
	\app{\lem[wit={N3,C6,V3,Gr2,Gr3a,Gr4c},alt={vṛndam}]{vṛnda\skp{m}}
		\rdg[wit={J10}]{cānnam}}%
...
\newpage
\begin{tlg}[hp04_032]% = V3_4.69 = C8_72
\tl{
...
\pada{\app{\lem[resp=emend]{nāda}
	...
	evānu\app{\lem[wit={N3,C6},alt={saṃdhānān}]{saṃdhānā\skp{n}}
		\rdg[wit={V3}]{saṃdhānā}
		\rdg[wit={J5,Gr4c,J10}]{saṃdadhyān} % °dhyā N19, saṃ<<da>>dhyān J10
...
%\newpage
\begin{tlg}[hp04_033]% = V3_4.52 = C8_55 = V17_70
\tl{
...
\app{\lem[wit={N23,Jyo}]{athārambhāvasthā}
		...
		\rdg[wit={N3,C6,V3},alt={\om}]{\skp{\om}}}/
	\NotIn{N3,C6,V3}
\end{ava}

\begin{tlg}[hp04_034]% = V3_4.53 = C8_56
\tl{
...
\begin{tlg}[hp04_035]% = V3_4.54ab = C8_57
\tl{
...
\pada{\app{\lem[wit={ceteri}]{saṃpūrṇa}
	...
	\app{\lem[wit={N3,P11,N19,Jyo}]{hṛdayaḥ}
		...
		\rdg[wit={C7}]{nilaye}}
	\app{\lem[wit={N3,Gr4c},alt={śūnye tv}]{śūnye\skp{ tv}}
...
\begin{tlg}[hp04_038]% = V3_4.57 = C8_60
\tl{
...
\pada{\app{\lem[wit={J5,N19,Jyo}]{vihāyo}% +J5
	...
	\app{\lem[wit={J5,C6,V3,Gr2,N19,J10,Jyo}]{mardala}% +J5
		...
		\rdg[wit={V15}]{mṛḍula}}%
	\app{\lem[wit={J5,C6,N23,Gr3a,Gr4c,J10,Jyo}]{dhvaniḥ}% +J5
		\rdg[wit={J7}]{dhvaniṃ}
...
\pada{\app{\lem[wit={V15,Jyo}]{kvaṇadvīṇākvaṇo}% viṇā V15
		...
		\rdg[wit={J7},post=\texteng{(\textless\ °vīṇolbaṇo?)}]{kvaṇadvīṇotvaṇo}
...
\newpage
\begin{tlg}[hp04_041]% = V3_4.60/61 = C8_63 %% P11 has Pada a only
\tl{
...
%\newpage
\startaltrecension
\begin{alttlg}[hp04_041_1]% = V3_4.62 = C8_64
\tl{
...
\begin{tlg}[hp04_042]% = V3_4.61/62 = 4c_106
\tl{
\pada{astu vā
...
\pada{ā niṣpatteḥ samabhyaset//}\myfn{Abbreviated with
\textit{haṭhaṃ vinā rājayoga iti} in \getsiglum{Gr4c}.\\
\getsiglum{Gr2,Gr3a} have the following verse instead of \ref{hathamvina}--\ref{ajananta}:
\devnote{haṭhaṃ vinā rājayogaṃ rājayogaṃ vinā haṭham/ 
ye vai caranti tān manye prayāsaphalavarjitān//}}\label{hathamvina}
\sgwit{Gr1r,Gr4b,Gr4c} \anm{= 2.77} \\!} % +M1,J11
\end{tlg}
...
\pada{\app{\lem[wit={Gr4c,J10,Jyo},post=\texteng{(°varjitāḥ \getsiglum{J10})}]{prayāsaphalavarjitān}
...
\pada{tattvaṃ\marmas bījaṃ % tattva N23,V3
	\app{\lem[wit={V19,Jyo}]{haṭhaḥ}
		...
		kṣetra}%m
\pada{\app{\lem[wit={GrB,Gr2,K3,C7,J10,Jyo},alt={audāsīnyaṃ}]{\skm{m }audāsīnyaṃ}
...
\pada{\app{\lem[wit={P11,J7,Gr3a}]{śūnyāśūnyaṃ}
		...
		\rdg[wit={C6}]{śūnyāc chūnyaṃ}}
	\app{\lem[wit={Gr1r,GrB}]{paraṃ padam} % +J5
...
\begin{tlg}[hp04_048]% = V3_4.165 %%% perhaps 6pāda-verse
\tl{
...
%\newpage
\begin{alttlg}[hp04_048_2]% = V3_4.167
\tl{
...
\pada{unmanyā\app{\lem[wit={GrB,V15,Jyo},alt={°vasthayā}]{\skp{°}vasthayā} % unmanyava° would be unmetrical. V15 has avagraha: unmanyā'va°
		\rdg[wit={J10}]{vasthāyāṃ}} dhruvam//} \sgwit{GrB,V15,J10,Jyo}\\!}
\end{alttlg}

\newpage
\begin{alttlg}[hp04_048_3]% = V3_4.168
\tl{
\pada{sarvāvasthāvinirmuktaḥ}
\pada{sarvacintā\app{\lem[wit={Gr4b,V15,J10,Jyo}]{vivarjitaḥ} % jita P11
		\rdg[wit={V3}]{vivarjitaṃ}}/}\\+}
\tl{
\pada{\app{\lem[wit={V15,J10,Jyo},alt={mṛtavat}]{mṛtava\skp{t}} % =G11
		\rdg[wit={GrB}]{kāṣṭhavat}}% =M1
	\app{\lem[wit={Gr4b,V15,J10,Jyo},alt={tiṣṭhate}]{\skm{t }tiṣṭhate}
...
%\newpage
\begin{alttlg}[hp04_048_4]% = V3_4.169
\tl{
...
%\newpage
\begin{alttlg}[hp04_048_5]%
\tl{
\pada{\app{\lem[resp=emend,postwit=\texteng{(cf.\,VM)}]{avedhyaḥ}
	\rdg[wit={V15,J10,Jyo}]{avadhyaḥ}} sarvaśastrāṇā}%m
\pada{\app{\lem[wit={V15,J10},alt={avadhyaḥ}]{\skm{m }avadhyaḥ}
...
\begin{alttlg}[hp04_048_6]% = V3_4.170
\tl{
...
\begin{alttlg}[hp04_048_7]% = V3_4.171
\tl{
...
\pada{\app{\lem[wit={ceteri}]{yasyāsau}
	...
	\app{\lem[wit={Gr4b,V15,J10},post=\texteng{(mukti \getsiglum{J10}\textsubscript{ac})}]{mukta eva saḥ} % +V15
		\rdg[wit={V3},alt={\illeg}]{\skp{\illeg}}}//}
		\sgwit{GrB,V15,J10,Jyo}\label{nasuptam}\\!} % yavaprasa in J8
\end{alttlg}

%\newpage
\begin{alttlg}[hp04_048_8]% = V3_4.172
\tl{
...
\pada{nāda%m % nadam P11
	\app{\lem[wit={Gr2,Gr3a,Gr4c},alt={antargataṃ sadā}]{\skm{m }antargataṃ sadā}
...
\pada{tatra cittaṃ % citta N23
	\app{\lem[wit={N3,C6,V3,Jyo}]{sthirī}
		\rdg[wit={Gr2,Gr3a,Gr4c}]{sthiraṃ}} kuryād}
\pada{yāva%t  % yāva Gr2,V3
	\app{\lem[wit={N3,C6,Gr2,Gr3a,Gr4c,Jyo},alt={sthirapadaṃ}]{\skm{t }sthirapadaṃ}
...
%\newpage
%========= common verses ==================
\begin{tlg}[hp04_053]% = V3_4.079 = 4c_75
\tl{
...
\tl{
\pada{\app{\lem[wit={N3,C6,V3,Gr2,K3,C7,Gr4c,Jyo},alt={pakṣād/pakṣāt}]{pakṣā\skp{d}}
%		\rdg[wit={K3}]{pakṣāt}
...
\pada{\app{\lem[wit={N3,C6,V3,J7,Gr3a,V15,Jyo}]{ante}
	...
	\app{\lem[wit={ceteri}]{tu}
		\rdg[wit={K3}]{ca}}
	kiṅkiṇī% °nī V19
	\app{\lem[wit={N3,Gr4c,J10,Jyo}]{vaṃśa}% vaṃśaṃ
...
\tl{
\pada{\app{\lem[wit={N3,C6,V3,Gr4c,J10,Jyo}]{tatra}
...
\pada{\app{\lem[resp=emend]{tau tyaktvā madhyame syād vā} % °me J5!
		\rdg[wit={N3,P11,V3},post=\texteng{(madhyamaḥ \getsiglum{C6})}]{tau tyaktvā madhyama syād vā}
...
\pada{\app{\lem[wit={N3,V3,V19},alt={gandhān}]{gandhā\skp{n}}
		...
		\rdg[wit={C6,J7,Gr4c,J10,Jyo}]{gandhaṃ}
		\rdg[wit={N23}]{gandha}}%
...
%\newpage
\startaltrecension
\begin{alttlg}[hp04_062_1]% = V3_4.74
\tl{
...
\tl{
\pada{prayāti
	\app{\lem[wit={V3},prewit=\texteng{\textless\ °sutendra}]{cetaḥsūtendraḥ}
...
\pada{\app{\lem[wit={N3,C6,V3,Gr2,C7,Jyo},alt={antaraṅga}]{\skm{m }antaraṅga}
		...
		\rdg[wit={K3}]{sarveṣām}}%
	\app{\lem[wit={N3,C6,V3,V19,Gr4c,J10,Jyo}]{bhujaṅgamaḥ} % ṃ om. V3
...
%\newpage
\begin{tlg}[hp04_065]% = V3_4.166; Upagīti
\tl{
...
\sgwit{N3,GrB,Gr2,Gr3a,Jyo}\label{anahata}\\!}
\end{alttlg}
\endaltrecension


%\newpage
\begin{tlg}[hp04_069]% = V3_4.87
\tl{
...
%\newpage
\begin{tlg}[hp04_071]% = V3_4.51 % Upagīti
\tl{
\pada{śravaṇa\app{\lem[wit={N3,C6,V3,Gr4c}]{mukha}
	...
	\app{\lem[wit={ceteri}]{nāsā} % nāśā V19,N19,V3
		\rdg[wit={Jyo}]{ghrāṇa}}%
	\app{\lem[resp=emend,postwit=\texteng{(cf.\,P6)}]{nirodhanaṃ caiva kartavyam}
...
\newpage
\startaltrecension
\begin{alttlg}[hp04_071_1]% = V3_4.89
\tl{
...
\begin{alttlg}[hp04_071_2]% = V3_4.90
\tl{
...
%\newpage
\begin{alttlg}[hp04_070_3]% = V3_4.91
\tl{
...
%\newpage
\begin{alttlg}[hp04_061]% = C8_84/85
\tl{
...
%%%%%%%%%%%%%%%%%%%%%%%
%\newpage
\begin{alttlg}[hp04_071_4]% = V3_4.159, cf. 4.089
\tl{
...
\tl{
\pada{yāva%
	\app{\lem[wit={N3,Gr4b,Gr4c},alt={vyomnā}]{\skm{d }vyomnā}
...
\pada{\app{\lem[wit={N3,P11,J7,Gr3a,V15,Jyo}]{bhoktrī} % bho<<ktrī>> N3
		...
		\rdg[wit={J10},alt={\om}]{\skp{\om}}}
	suṣumṇā kālasya}
\pada{\app{\lem[wit={N3,GrB,J7,Gr4c,Jyo},alt={guhyam etad}]{guhyam eta\skp{d}}
...
%\stopvline
%\setcounter{poemline}{0}
\begin{alttlg}[hp04_077_1]% = V3_4.179/180
\tl{
...
\pada{sa \app{\lem[wit={Gr3a}]{mukto}% +G4,G7 (eye-skip to the next verse?)
	...
	nātra saṃśayaḥ//}
	\sgwit{N3,GrB,Gr3a} \anm{= 3.107}\\!} % +B2
\end{alttlg}
% V3 has a gap indicated before the following verse.

%\newpage
\begin{alttlg}[hp04_077_2]% = V3_4.181
\tl{
...
\pada{sa mukto nātra saṃśayaḥ//} \sgwit{N3,GrB}\\!} % not in G4,B2
\end{alttlg}
%\startvline
\endaltrecension
...
\pada{vāyuḥ % vāyu V19,P11
	...
	\app{\lem[wit={N3,Gr4b,J7,V19,Gr4c},alt={yatnād}]{yatnā\skp{d}}
		\rdg[wit={C7}]{yadvad}
		\rdg[wit={J10,Jyo}]{yasmād}
		\rdg[wit={V3}]{nādād}}}%
\pada{\app{\lem[wit={GrB,V19,C7,Gr4c,J10,Jyo},alt={agninā}]{\skm{d }agninā} % agnidā N19
		\rdg[wit={J7}]{ṛgvinā}
...
\pada{\app{\lem[wit={N3,Gr4b,J7,V19,C7,Gr4c,Jyo},alt={praviśed}]{praviśe\skp{d}}
		\rdg[wit={V3}]{praveśad}
		\rdg[wit={J10},alt={\om}]{\skp{\om}}}%
...
\pada{\app{\lem[wit={Gr1r},alt={drutaṃ dvāv api naśyataḥ}]{\skm{n }drutaṃ dvāv api naśyataḥ}% [dgu]ttaṃ N3, dṛtaṃ J5, dṛutaṃ G4
...
\pada{\app{\lem[wit={N3,GrB,J7,V19,C7,Jyo},alt={pavanas}]{pavana\skp{s}}
		\rdg[wit={Gr4c}]{mārutas}}s tatra līyate/}\\+}
\tl{
...
\pada{mana\app{\lem[wit={N3,GrB,V19,C7},alt={tatraiva līyate}]{\skm{s }tatraiva līyate}% +N2
		...
		\rdg[wit={Gr4c},alt={\om}]{\skp{\om}}}//}\myfn{%
...
\pada{tulyakriyau % kriyo N19
	...
	\app{\lem[wit={N3,P11,Gr4c,J10,Jyo}]{hi}
		\rdg[wit={C6,V3,J7,V19,C7}]{ca}% + all testimonia
		}/}\\+}
\tl{
\pada{\app{\lem[wit={N3,GrB,J7,V19,C7,Gr4c},alt={yāvan manas}]{yāvan mana\skp{s}}
		\rdg[wit={J10,Jyo}]{yato marut}}s tatra
	\app{\lem[wit={N3,GrB,J7,V19,C7,Gr4c},alt={marut}]{maru\skp{t}} % marat V15
...
\pada{\app{\lem[wit={N3,GrB,J7,V19,C7},alt={yāvan}]{\skm{r }yāva\skp{n}}
		...
		\rdg[wit={Gr4c},alt={\om},post=\texteng{(pāda d om.)}]{}}%
	...
	\app{\lem[wit={N3,GrB,J7,V19,C7,Jyo}]{pravṛttiḥ} % °vṛttaḥ C6, °vartiḥ P7
		...
		\rdg[wit={Gr4c},alt={\om}]{\skp{\om}}}//}\label{dugdha}\\!}
\end{tlg}

%\newpage
\begin{tlg}[hp04_085]% = V3_4.189
\tl{
...
\pada{\app{\lem[wit={N3,GrB,J7,N19,Jyo},alt={ekapravṛtter}]{ekapravṛtte\skp{r}}% vṛtte ca C6
	...
	\app{\lem[wit={N3,GrB,J7,V19,C7,Gr4c,Jyo},alt={aparapravṛttiḥ}]{\skm{r }aparapravṛttiḥ} % °ttir N19, °tt<<i>>ḥ N3
...
\pada{\app{\lem[wit={N3,GrB,V19,C7,V15},alt={vidhvastayor}]{\skm{r }vidhvastayo\skp{r}}
	...
	\app{\lem[wit={N3,GrB,V19,Gr4c,J10,Jyo},alt={mokṣapadasya siddhiḥ}]{\skm{r }mokṣapadasya siddhiḥ} % siddhi V19
...
\app{\lem[wit={N3,Gr4b}]{tathā}
	\rdg[wit={J7,V19,C7},alt={\om}]{\skp{\om}}} viśvarūpācāryaḥ/
...
%\newpage
%%%%%%%%%%%%%%%%%%%%%%%
\begin{tlg}[hp04_089]% = V3_4.191 (N23,K3,J15 lost)
\tl{
...
iti \app{\lem[wit={V3,C7,J10}]{śrī}
	...
	\rdg[wit={C6,P11,V19},alt={\om}]{\skp{\om}}}%
