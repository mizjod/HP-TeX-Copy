...
\pada{\app{\lem[wit={V15,Jyo}]{rājayogaḥ}
	...
	\app{\lem[wit={N19,V15},alt={samādhiḥ syād}]{samādhiḥ syā\skp{d}} % samādhi V15
...
\myfn{\getsiglum{C6} has these verses on synonyms both here and at \ref{A1}/\ref{A2}, but \getsiglum{P11} at the latter place only.}\\!}
\end{alttlg}
\endaltrecension
...
\pada{\crux\app{\lem[wit={ceteri},alt={jñānān}]{jñānā\skp{n}}
	...
	\app{\lem[wit={C6,N19,V15,Jyo},alt={siddhir}]{siddhi\crux\skp{r}}
...
\pada{prāṇaḥ śūnye % prāṇaṃ C6; prāṇa V15
	\app{\lem[wit={C6,N23,Gr3a,J10}]{vilīyate}
		...
		\rdg[wit={V3,N19,V15,Jyo}]{pralīyate}}//}\\!}
\end{tlg}
...
\pada{\app{\lem[wit={P11,V15}]{śūnyaṃ}
	...
	\app{\lem[wit={P11,V3,Jyo}]{mānase} % Marmasthāna
		\rdg[wit={J10}]{mārutaḥ}
		\rdg[wit={C6,Gr2,Gr3a,N19,V15}]{mārute}}\marma/}\\+}
\tl{
...
\pada{mārutasya layo
	\app{\lem[wit={ceteri},alt={nāthas/nāthaḥ/nātho}]{nātha\skp{s/nāthaḥ/nātho}}
		\rdg[wit={J7}]{nāthāḥ}}}%
\pada{\app{\lem[wit={N3,V3,N19,V15,J10},alt={taṃ nāthaṃ layam āśrayet}]{\skm{s }taṃ nāthaṃ layam āśrayet}
...
\pada{\app{\lem[wit={Gr2,Gr3a}]{nāpi}
	...
	\app{\lem[wit={J7,Gr3a},alt={vibhidyate}]{\skm{d }vibhidyate}
		...
		\rdg[wit={C6,N19,V15,J10,Jyo}]{pravartate}% ##
...
\pada{\app{\lem[wit={ceteri},alt={candrārkāv}]{candrārkā\skp{v}}
	...
	\app{\lem[wit={Gr2,Gr3a,N19,V15},alt={upanayen}]{\skm{m }upanaye\skp{n}} % upanaye V19,N19
...
\pada{kiṃci%d
	...
	\lineom{ab}{N3}\\+}
\tl{
\pada{\app{\lem[wit={V3,K3,C7,N19,V15},alt={pūrvayogasya mārgo'yam}]{pūrvayogasya mārgo'ya\skp{m}}
...
\Anm{The following verses are not found in \getsiglum{N3,Gr2,Gr3a}, but in \getsiglum{GrB,N19,V15,J10,Jyo}}
...
\pada{\app{\lem[wit={GrB,N19,Jyo},alt={abhyaset}]{abhyase\skp{t}}
	...
	\app{\lem[wit={GrB,N19,V15,J10},alt={khecarī}]{\skm{t }khecarī}
		\rdg[wit={Jyo}]{khecarīṃ}}% +J11
	\app{\lem[wit={V15,J10}]{mudrāṃ}
		\rdg[wit={N19}]{mudrā}
		\rdg[wit={GrB,Jyo}]{tāvad}}}
\pada{\app{\lem[wit={N19,V15,J10},alt={tāvat}]{tāva\skp{t}} % tāva
...
\pada{\app{\lem[wit={GrB,V15,J10,Jyo}]{ghaṭa}
	...
	\app{\lem[wit={N19,V15},alt={tiṣṭhate}]{\skm{t }tiṣṭhate}
...
\pada{\crux\app{\lem[wit={C6,V3,N19,V15}]{sūryāṅge manasā tathā}% sūryāgnir M1
...
\pada{\app{\lem[wit={GrB,N19,J10,Jyo}]{abhyāsāj jīryate} % abhyāsā V3
		...
		vāyur} % vāyu V3
\pada{mana\app{\lem[wit={N19,V15,J10},alt={tatra vilīyate}]{\skm{s }tatra vilīyate}
...
\tl{
\pada{\app{\lem[wit={N19,V15,J10,Jyo}]{sarvaṃ ca}
...
\tl{
\pada{saṃkalpamātra%
	\app{\lem[wit={V3,N19,V15}]{kalanā hi}
...
\app{\lem[wit={N23,Jyo}]{athārambhāvasthā}
		...
		\rdg[wit={N19,V15}]{tatra ārambhaḥ}
...
\pada{\app{\lem[wit={C6,Gr3a,Jyo},post=\texteng{(°te \getsiglum{K3})},alt={atraivākhaṇḍitaṃ}]{\skm{r }atraivākhaṇḍitaṃ}
	...
	\app{\lem[wit={ceteri}]{mahat}
		...
		\rdg[wit={Jyo}]{sukham}}/}\\+}
\tl{
\pada{\app{\lem[wit={Gr1r,C6,N19,V15}]{layāmṛtamayaṃ}% +J5,N24
...
\tl{\pada{\app{\lem[wit={Gr2,K3,C7}]{haṭhaṃ vinā}
...
\pada{mūḍhānām api saṃmatam/}
	\sgwit{Gr1r,GrB,Gr2}\\+} %\lineom{ab}{Gr3a,N19,V15,J10,Jyo}
\tl{
...
\pada{\app{\lem[wit={Gr4b,V15,J11,Jyo}]{yasyāsau}
		\rdg[wit={J10}]{yathāsau}} mukta eva saḥ % mukti J10ac
...
\label{sarvacinta2} \anm{after \ref{sarvacinta} in \getsiglum{N19,V15,J10}}\\!}
\end{tlg}
...
\pada{tāva\app{\lem[wit={ceteri},alt={sarvaṃ}]{\skm{t }sarvaṃ}
	...
	\anm{after 4.5 in \getsiglum{N19,V15,J10}}\label{yavan}\\!}
\end{tlg}
...
\pada{satyaṃ \app{\lem[wit={N3,GrB,J7,V19,C7}]{satyaṃ varānane}
	...
	\anm{after 4.12 in \getsiglum{N19,V15,J10}}\\!}
\end{tlg}
...
\NotIn{V3,N19,V15,J10} \anm{after \ref{salile} in \getsiglum{Jyo}}\\!}
\end{tlg}
...
\pada{piṇḍasthairyaṃ prajāyate//}
	...
	\anm{after 4.12 in \getsiglum{N19,V15,J10,Jyo}}\\!}
\end{tlg}
...
\anm{after \ref{sravanaputa} in \getsiglum{N19,V15,J10}}\\!} % ḥ om. V3
\end{tlg}
